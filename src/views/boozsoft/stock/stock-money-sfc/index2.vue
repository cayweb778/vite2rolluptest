  ...
  <div>
    ...
    <div class="app-container">
      ...
      >
        ...
        <template #qcprice="{ record }"><span>{{toThousandFilter(record.qcprice)}}</span></template>
        <template #qcicost="{ record }"><span>{{toThousandFilter(record.qcicost)}}</span></template>
        <template #rk="{ record }"><span>{{toThousandFilter(record.rk)}}</span></template>
        <template #rkprice="{ record }"><span>{{toThousandFilter(record.rkprice)}}</span></template>
        <template #rkicost="{ record }"><span>{{toThousandFilter(record.rkicost)}}</span></template>
        <template #ck="{ record }"><span>{{toThousandFilter(record.ck)}}</span></template>
        <template #ckprice="{ record }"><span>{{toThousandFilter(record.ckprice)}}</span></template>
        <template #ckicost="{ record }"><span>{{toThousandFilter(record.ckicost)}}</span></template>
        <template #qimo="{ record }"><span>{{toThousandFilter(record.qimo)}}</span></template>
        <template #qmprice="{ record }"><span>{{toThousandFilter(record.qmprice)}}</span></template>
        <template #qmicost="{ record }"><span>{{toThousandFilter(record.qmicost)}}</span></template>

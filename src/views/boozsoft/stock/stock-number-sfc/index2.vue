  ...
  <div>
    ...
    <div class="app-container">
      <BasicTable
        ...
        :loading="loadMark"
      >
        <template #qichu="{ record }"><span>{{toThousandFilter(record.qichu)}}</span></template>
        <template #qichu1="{ record }"><span>{{toThousandFilter(record.qichu1)}}</span></template>
        <template #qichu2="{ record }"><span>{{toThousandFilter(record.qichu2)}}</span></template>
        <template #rk="{ record }"><span>{{toThousandFilter(record.rk)}}</span></template>
        <template #rk1="{ record }"><span>{{toThousandFilter(record.rk1)}}</span></template>
        <template #rk2="{ record }"><span>{{toThousandFilter(record.rk2)}}</span></template>
        <template #ck="{ record }"><span>{{toThousandFilter(record.ck)}}</span></template>
        <template #ck1="{ record }"><span>{{toThousandFilter(record.ck1)}}</span></template>
        <template #ck2="{ record }"><span>{{toThousandFilter(record.ck2)}}</span></template>
        <template #qimo="{ record }"><span>{{toThousandFilter(record.qimo)}}</span></template>
        <template #qimo1="{ record }"><span>{{toThousandFilter(record.qimo1)}}</span></template>
        <template #qimo2="{ record }"><span>{{toThousandFilter(record.qimo2)}}</span></template>
        <template #summary>
          <TableSummary fixed>
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          dataIndex: 'qichu1',
          key: '6-2',
          align: 'right',width: 130,slots: { customRender: 'qichu1' }
        },
        {
          title: '数量2',
          dataIndex: 'qichu2',
          key: '6-3',
          align: 'right',width: 140,slots: { customRender: 'qichu2' }
        }
      ],
    },
    {
      ...
      children: [
        {
          ...
          dataIndex: 'rk',
          key: '7-1',
          align: 'right',width: 130,slots: { customRender: 'rk' }
        },
        {
          title: '数量1',
          dataIndex: 'rk1',
          key: '7-2',
          align: 'right',width: 130,slots: { customRender: 'rk1' }
        },
        {
          title: '数量2',
          dataIndex: 'rk2',
          key: '7-3',
          align: 'right',width: 140,slots: { customRender: 'rk2' }
        }
      ],
    },
    {
      ...
      children: [
        {
          ...
          dataIndex: 'ck',
          key: '8-1',
          align: 'right',width: 130,slots: { customRender: 'ck' }
        },
        {
          title: '数量1',
          dataIndex: 'ck1',
          key: '8-2',
          align: 'right',width: 130,slots: { customRender: 'ck1' }
        },
        {
          title: '数量2',
          dataIndex: 'ck2',
          key: '8-3',
          align: 'right',width: 140,slots: { customRender: 'ck2' }
        }
      ],
    },
    {
      ...
      children: [
        {
          ...
          dataIndex: 'qimo',
          key: '9-1',
          align: 'right',width: 130,slots: { customRender: 'qimo' }
        },
        {
          title: '数量1',
          dataIndex: 'qimo1',
          key: '9-2',
          align: 'right',width: 130,slots: { customRender: 'qimo1' }
        },
        {
          title: '数量2',
          dataIndex: 'qimo2',
          key: '9-3',
          align: 'right',width: 140,slots: { customRender: 'qimo2' }
        }
      ],
    },
  ]

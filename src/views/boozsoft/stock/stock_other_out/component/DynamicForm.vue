  ...
  <div class="dynamic-form">
    <BasicForm @register="register"  ref="formElRef">
      <template #unitType="{ model, field }">
        <Select placeholder="其他/客户/供应商/员工/项目" v-model:value="model[field]" ref="cvencodeRef" :show-search="true" :disabled="model['bstyle'] != '其他出库'"
      ...
      <template #unitValue="{ model, field }">
        <Select v-if="model['unitType'] != 'etc'" placeholder="请选择" v-model:value="model[field]" ref="cvencodeJsRef" :show-search="true" :disabled="model['bstyle'] != '其他出库'"
        ...
        <Input placeholder="输入"  v-else v-model:value="model[field]" :disabled="model['bstyle'] != '其他出库'" />
      </template>

      <template #cwhcode="{ model, field }">
        <Select placeholder="请选择" v-model:value="model[field]" :show-search="true"  :disabled="model['bstyle'] != '其他出库'"

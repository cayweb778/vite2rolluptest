  ...
  <div>
    <div class="app-container lcr-theme-div">
      <div>
        ...
        <div>
          <AccountPicker style="background-color: #f5f5f5;"  theme="three" readonly @reloadTable="dynamicAdReload" />
          <div>
            <div style="margin-left: 10px;margin-top: 5px;">
              <b><span style="color: #666666;padding-left:5px;">活动名称：</span>{{routemsg.activityName}}</b>
              <b><span style="color: #666666;padding-left:5px;"> 活动范围：</span>{{routemsg.activityScope=== '1' ? '全部客户' : '选定客户'}}</b>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <div>  <b class="noneSpan" style="font-size: 26px;color: #0096c7;">促销活动价格表</b></div>
        <div><span style="font-size: 14px;font-weight: bold;"><span style="  font-weight: bold;color: #666666;">期间：</span>{{routemsg.activityDate}}</span></div>
      </div>
...
<!--          <Button type="button"
        ...
        <div>
          <a-select v-model:value="selectSearchValue" class="acttdrd-search-select" style="width: 150px;text-align: left;font-size: 12px;"
                    @change="selectSearch2">
            <a-select-option value="ccode">存货编码</a-select-option>
            <a-select-option value="ccodeName">存货名称</a-select-option>
          </a-select>
          <a-input-search placeholder="" v-model:value="inputsearchtext" style="width: 150px;text-align: left;font-size: 12px;"
    ...
    <div class="app-container-bottom" :style="{height: (windowHeight+60)+'px',display: 'inline',width: '60%',float: 'left',marginLeft: '10px'}">
      <BasicTable
        ref="tableRef"
...
<!--              <EditOutlined @click="record.stockNumEdit = true;record.oldstockNum=record.stockNum"/>-->
      ...
      <div class="pagination-text" style="position: absolute;top:97%; bottom: 6px; right: 45%;font-size: 13px; color: black;z-index: 99999999;">
